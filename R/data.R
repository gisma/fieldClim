...
#'   \item{rad_sw_in}{Incoming shortwave radiation in W/m\eqn{^2}.}
#'   \item{rad_sw_out}{Outgoing shortwave radiation in W/\eqn{^2}.}
#'   \item{rad_lw_in}{Incoming longwave radiation in W/m\eqn{^2}.}
#'   \item{rad_lw_out}{Outgoing longwave radiation in W/m\eqn{^2}.}
#'   \item{rad_sw_bal}{Shortwave radiation balance in W/m\eqn{^2}.}
#'   \item{rad_lw_bal}{Longwave radiation balance in W/m\eqn{^2}.}
#'   \item{albedo}{Albedo of ground.}
#'   \item{rad_bal}{Total radiation balance in W/m\eqn{^2}.}
#'   \item{water_vol_soil}{Moisture of ground in %.}
#'   \item{t_surface}{Surface temperature in °C.}
#'   \item{ts1}{Temperature soil, 30 cm depth.}
#'   \item{heatflux_soil}{Soil heat flux in W/m\eqn{^2}.}
